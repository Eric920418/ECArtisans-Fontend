<template>
	<div class="container">
		<!-- swiper 開始 -->
		<div class="swiper d-flex flex-column h-100 w-100" ref="cardSwiper">
			<!-- swiper-wrapper 容器 -->
			<ul class="swiper-wrapper">
				<!-- 要作為輪播子元素的區塊，需要加上 swiper-slide 這個 class -->
				<li
					class="swiper-slide list-unstyled card position-relative card-shadow"
